/*  setting event listner on salary range to display appropriate value
    validation of name and date */

window.addEventListener('DOMContentLoaded', (event) => {
    const name = document.querySelector('#name'); const textError = document.querySelector('.text-error');
...
const resetForm = () => {
    setValue('#name', '');
    setSelectedValues ('[name=profile]');
    unsetSelectedValues ('[name=gender]');
    unsetSelectedValues ('[name=department]');
    setValue('#salary', '');
    setValue('#notes', ''); setValue( '#day', '1');
